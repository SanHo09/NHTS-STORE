...
public class ProductCategoryEditDialog extends JDialog implements GenericEditDialog<Category> {
    @Autowired
    ...
    public ProductCategoryEditDialog() {
    ...
    private void save() {
       try {
           Category updatedCategory = category != null ? category : new Category();
